      ...
      <div className="bg-white rounded-xl shadow-xl p-8 w-full max-w-md">
        ...
        {stage === "reset" && (
          <>
            ...
            <p className="text-lg font-bold text-center text-[#1b5e20] mb-2">{phone}</p>
            <div className="bg-amber-50 border border-amber-200 text-amber-700 text-xs p-2.5 rounded-lg mb-4 text-center">
              SMS can take up to 5 minutes to arrive. Please wait before requesting again — requesting a new code cancels the previous one.
            </div>
            {devCode && (
